        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-6 mt-8">
              <h4 className="text-xl font-bold text-red-400 mb-2">Special Hours</h4>
              <p className="text-gray-300">
                During holidays, our hours may vary. Please call ahead to confirm 
                our availability for special occasions and private events.
              </p>
            </div>
          </div>
